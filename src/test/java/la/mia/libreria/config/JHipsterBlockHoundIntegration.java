...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("la.mia.libreria.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("la.mia.libreria.security.DomainUserDetailsService", "createSpringSecurityUser");
